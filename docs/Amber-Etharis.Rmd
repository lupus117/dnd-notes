...
<image src="../Etharis/Dreamland_travellers.png" class="halfSize" style="width:50%">
...
![](../Etharis/vampire_w_wolves.png){.threeQuartersSize width="75%" .round}
...
![](../Etharis/Bandersnatch_transparent.png){.threeQuartersSize width="75%"}
...
![The Bandersnatch](../Etharis/Bandersnatch_transparent.png){.threeQuartersSize .zoom width=66%}
...
Claus | Description
:----: | :------
![](../Etharis/vampire_w_wolves.png){.circle } | In front of them is an individual. Flanked by two wolves, shadowy. Their face taking shape as they reach up with their hand, round glasses with red eyes hiding behind. A Vampire with a shadowy wolf in his shadow.  
...
![](../Etharis/cow-pot.png){.round .halfSize width=50%}
...
![](../Etharis/Pierre_Snowcat_Tokenv3.png)
