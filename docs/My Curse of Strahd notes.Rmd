...
:--:|:--:|:--:|:--:|:--:
![](../Barovia/Vladimer_token.png) | ![](../Barovia/Janosh_token.png) | ![](../Barovia/Jodariel_token.png) | ![](../Barovia/Aculeus_token.png) | ![](../Barovia/oscar_token.png){.token}
...
![Map of barovia](../.\Barovia\map.png) 
...
![Map of Vallaki](../.\Barovia\osv521xq3hi21.jpg)
...
#### Father Lucien
 Father Lucien | 
---|--
Father Lucien is the man leading the church of St Andral, devout follower of the morning lord and generous person. He funds the Orphanage next door and keeps in god's good graces. | ![Father Lucien](../.\Barovia\Lucien.png){.token}  
...
![Bluewater Inn](../.\Barovia\bluewater.jpg)  
...
#### Riktavio
 Riktavio | 
---|--
Half-elf Carnivalmaster from a faraway land. Knows more than he tries to let on. Follows the party around sometimes. Bought toys from Blinski to spread them around to those in need. | ![Riktavio](../.\Barovia\Riktavio.png){.token}
...
#### Mistress Balasco
 ...
 Claudia Balanco | 
---|--
The headmistress of the Saint Andral Orphanage. With a hard not going to back down attitude but kind as she helps the children brought to her orphanage. | ![Mistress Balanco](../.\Barovia\Claudia_Ballasco.png){.token}

#### Milivaj

 Milivaj | 
---|--
Gravedigger and young adult. Cares deeply for the children of the orphanage and will do what he must to protect them. Millivaj grew up in the Orphanage and has been working as a gravedigger for a long time now. | ![Millivaj](../.\Barovia\Millivaj.png){.token}
...
#### Vargas Vallakovich, Burgomaster of Vallaki
 ...
 Vargas Vallakovich | 
---|--
The Burgomaster and self-proclaimed Baron of Vallaki (New Valekia).  Seems to be suffering from some sort of **Bipolar** disorder, where he switches from extremely cheery to serious. His room is packed wall to wall and ceiling to ceiling in books | ![Vargas Vallakovich](../.\Barovia\Baron_Vargas.png){.token}
...
#### Izek Stratzni
 Izek Stratzni | 
---|--
**Captain** of the guard with a fiendish arm. And adopted son of **Vargas the Burgomaster**. Mean attitude and not the most liked.| ![Izek Stratzni](../.\Barovia\Izek Stratzni.png){.token}
...
![Fiona](../Barovia/fiona_token.png){.token} | ![Ernst](../Barovia/Ernst.png){.token}
...
Mr Blinski |
-----|----
Current owner and toymaker of the Blinski toy company. Is accompanied by a monkey called Piccolo. Seems good hearted and afraid of Izek | ![Blinski](../Barovia/Blinsky.png){.token}
...
Aculeus bought a wind up raven  
![Wind up raven](../Barovia/Wind-Up_Raven.jpg){.token width=50%}
...
![Town of Barovia](../.\Barovia\Town_of_barovia.jpg)

### Ireena Kolyanovich

Ireena Kolyanovich|  
----|--
Red hair eyes and youthful appearance.21 years old and the **Adopted** daughter of Kolyan Indirovich. **Strahd has taken intrest** in her as have many others. **Izek** seems obsessed, ordering dolls from **Blinski** that look like her. Though they never seem to have met.| ![Ireena](../Barovia/Ireena.png){.token}
...
Ismark Kolyanovich|
---|---
Brown hair and eyes. Ismark is the son of the previous burgomaster **Kolyan Indirovich**. He is capable in combat but now infected with the curse of lycanthropy. Good heart but shy. Bit aloof and a playboy, he quite enjoys partying. | ![Ismark](../Barovia/Ismark.png){.token}
...
Rose and Thorn |
--|--
The older kids of the durst family, may they rest in peace | ![](../Barovia/Rose_Thorn.png){.token}
...
----------|-------
This card sheds light on one who will help you greatly in the battle against darkness. A Vistani wanders this land alone, searching for her mentor. She does not stay in one place for long. Seek her out in the mists. | ![The Mists](.././Barovia/Mists.png)

**Esmeralda D'Avenir** |
----------|-------
Student of Van Richten. A vistani orphan, who went to learn with the Famous Van Richten, she now looks for her master to get his help. | ![Esmeralda](../Barovia/Esmeralda.png){.token }
...
![Count Strahd von Zarovich](../.\Barovia\Strahd.png)  
...
#### Rahadin
 Rahadin | 
---|--
The Elf followed by the screams of his victims.  **Strahd**'s right hand man. Could be the broken elf mentioned in **The broken one** fortune  | ![Rahadin](../.\Barovia\Rahadin.png){.token}  

#### Anastrasya
 Anastrasya Karelova| 
---|--
One of **Strahd**'s wives, leads the lycan pack though commanding **Keril**. Vampire who once charmed and chomped on **Vlad** | ![Anastrasya](../.\Barovia\Anastrasya.png){.token}  
...
--|--|--
![Muriel Martikov](../.\Barovia\Muriel.png){.token} | ![Urwin Martikov](../.\Barovia\Urwin.png){.token} | ![Danika Martikov](../.\Barovia\Danika.png){.token}
...
![](../Barovia/Davian_token.png) | ![](../Barovia/Adrian.png)
...
Gertruda |
--|--
Young girl stolen by the hags, to be turned into one. She has a scar in the shape of an upside down bowl with a dot on her forehead.  She has a good heart and is afraid of what is happening to her. She was brave in getting the little ones out of the tower. She has a mother in the town of Barovia and a dog to help us find her. | ![Gertruda](../Barovia/gertruda.png){.token}

Granny Morgantha |
--|--
Evil bitch. Meets Ludwig at the sunset gate.| ![Morgantha](../Barovia/morgantha.png){.token}
...
![Aculeus, blessed by the fane](../.\Barovia\Aculeus_blessing.png){.token width=100%}  
...
## History {.justify}
![](../.\Barovia\Aculeus_og.jpg){width=33.3%}![](../.\Barovia\Aculeus_awakened.jpg){width=33.3%}![](../.\Barovia\Aculeus_blessing.png){width=33.3%}
...
---|---
![](../Barovia/Umbra.png){.token} | ![](../Barovia/Fenrir1_5.jpg){.token}
...
### The Transmuter {.book}
![The transmuter](../.\Barovia\Transmuter.png)  
